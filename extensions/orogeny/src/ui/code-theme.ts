...
export const tokyoNightMoon = {
  ...
  captures: {
    ...
    "diff.delta": { foreground: moon.blue },
    "diff.minus": { foreground: moon.red },
    "diff.plus": { foreground: moon.green },
    ...
    "patch.add": { foreground: moon.gitAdd },
    "patch.boundary": { foreground: moon.magenta },
    "patch.context": { foreground: moon.gitChange, bold: true },
    "patch.delete": { foreground: moon.gitDelete },
    "patch.eof": { foreground: moon.magenta, italic: true },
    "patch.file": { foreground: moon.fgDark, bold: true },
